        ...
        >
            ...
            <div className="flex-1 px-6 py-4 flex flex-col items-center text-center space-y-3">
                ...
                <div className="flex items-center space-x-1.5">
                    ...
                    <span className="ml-1 text-sm font-medium text-gray-600">({tutor.rating?.toFixed(1) || 4.8})</span>
                </div>
            ...
            <div className="p-4 border-t border-gray-100">
                <motion.button
                    ...
                    className="btn w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md transition-colors"
