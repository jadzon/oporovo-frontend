...
const TutorCard = ({ tutor, onInfoClick }) => {
    ...
    return (
        ...
        >
            ...
            {/* Tutor Details */}
            <div className="flex-1 px-4 flex flex-col items-center text-center space-y-3">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    {halfStar && (
                        <FaStar key="half" className="w-5 h-5 text-purple-500 opacity-50" />
                    )}
            ...
            <div className="p-4">
                <motion.button
                    ...
                    transition={{ duration: 0.15 }}
                    className="btn w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded shadow transition"
