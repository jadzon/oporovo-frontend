...
export const LessonSchedulingForm = ({ tutor, error, setError, onFormSubmit }) => {
    ...
    const renderBlockSelection = () => {
        ...
        const blockInfo = (
            <p className="text-xs text-gray-500 mb-3">Każdy blok trwa 45 minut</p>
        );
                            ...
                            <div className="mt-3">
                                {selectedAdjacentBlock ? (
                                    ...
                                    <button
                                        ...
                                        className="w-full mt-3 py-1.5 px-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md transition-colors flex items-center justify-center gap-2"
                                    >
              ...
              `}</style>
                                    ...
                                    <div className="mt-4 space-y-2">
                                        ...
                                        {tutor?.price && (
                                            <div className="flex justify-between items-center text-sm">
                                                ...
                                                <span className="font-medium text-blue-600">{formatUtils.formatPrice(totalPrice)}</span>
                                            </div>
                                        )}
                                    </div>
                                )}
                    ...
                    <div className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                        >
