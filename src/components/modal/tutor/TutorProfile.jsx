        ...
        <div className="flex flex-col h-full">
                ...
                <div className="space-y-4 pb-20">
                    ...
                    <Card>
                        <p className="text-gray-700 text-sm leading-relaxed">
                            {tutor?.description ||
                                "Doświadczony nauczyciel z pasją do przekazywania wiedzy, pomagający uczniom osiągać ich cele edukacyjne."}
                        </p>
                    </Card>
                    {/* Edukacja */}
                    ...
                    <Card title="Specjalizacje" icon="tag">
                        <div className="flex flex-wrap gap-2">
                            {subjectOptions.map((sub) => (
                                <span key={sub} className="px-2.5 py-1 bg-gray-50 text-black rounded-full text-xs font-medium">
                  {sub}
                </span>
                            ))}
                        </div>
            ...
            <div className="border-t border-gray-200 p-4 bg-white">
                <button
                    ...
                    className="w-full flex justify-center items-center gap-2 px-4 py-2.5 bg-black hover:bg-gray-800 text-white text-sm font-medium rounded-full shadow-sm transition-colors"
                >
