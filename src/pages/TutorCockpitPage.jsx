...
import { FaCalendarAlt, FaUserGraduate, FaChalkboardTeacher, FaCheck } from 'react-icons/fa';
...
const TutorCockpitPage = () => {
    ...
    const needsConfirmationLessons = useMemo(() => {
        return lessonsArray.filter(lesson =>
            lesson.status === 'scheduled' && new Date(lesson.start_time) > now
        );
    }, [lessonsArray, now]);
    ...
    const handleViewStudents = () => alert('Przejdź do listy uczniów...');
    const handleManageMaterials = () => alert('Zarządzaj materiałami dydaktycznymi...');
                    ...
                    <div className="py-8">
                        ...
                        >
                            <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">
                                Panel <span className="text-blue-900">nauczyciela</span>
                            </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                            <div className="rounded-full bg-blue-50 p-4 mb-4">
                                <FaCalendarAlt className="h-6 w-6 text-blue-900" />
                            </div>
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Harmonogram</h3>
                            <p className="text-sm text-gray-600 mb-4">
                                Ustaw swoje dostępne godziny i zarządzaj kalendarzem lekcji
                            </p>
                            <button
                        ...
                        >
                            <div className="rounded-full bg-blue-50 p-4 mb-4">
                                <FaUserGraduate className="h-6 w-6 text-blue-900" />
                            </div>
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Uczniowie</h3>
                            <p className="text-sm text-gray-600 mb-4">
                                Przeglądaj listę uczniów i śledź ich postępy w nauce
                            </p>
                            <button
                        ...
                        >
                            <div className="rounded-full bg-blue-50 p-4 mb-4">
                                <FaChalkboardTeacher className="h-6 w-6 text-blue-900" />
                            </div>
                            <h3 className="text-lg font-medium text-gray-900 mb-2">Materiały</h3>
                            <p className="text-sm text-gray-600 mb-4">
                                Zarządzaj swoimi materiałami dydaktycznymi i zadaniami
                            </p>
                            <button
                ...
                {needsConfirmationLessons.length > 0 && (
                    <section className="mb-10">
                        <motion.div
                            ...
                            className="bg-amber-50 rounded-lg shadow-sm border border-amber-200 overflow-hidden"
                        >
                            ...
                            <div className="p-6">
                                <div className="space-y-4">
                                    <p className="text-amber-800">
                                        Masz {needsConfirmationLessons.length} {needsConfirmationLessons.length === 1 ? 'zaplanowaną lekcję' :
                                        needsConfirmationLessons.length < 5 ? 'zaplanowane lekcje' : 'zaplanowanych lekcji'},
                                    ...
                                    {needsConfirmationLessons.length > 3 && (
                                        <div className="text-center mt-4">
                                            <button
                                                ...
                                                className="text-sm font-medium text-blue-900 hover:text-blue-800 hover:underline transition-colors"
                                            >
                                                Zobacz wszystkie
                                            </button>
                                        </div>
                                ...
                                <div className="md:w-1/2 flex flex-col justify-center">
                                    {lessonsLoading ? (
                                        ...
                                        <>
                                            ...
                                            <div className="mb-4">
                                                <span className={`text-sm inline-block px-3 py-1 rounded-full ${
                                                    upcomingLessons[0].status === 'confirmed' ? 'bg-emerald-100 text-emerald-800' :
                                                        upcomingLessons[0].status === 'scheduled' ? 'bg-indigo-100 text-indigo-800' :
                                                            'bg-gray-100 text-gray-800'
                                                }`}>
                                                    {upcomingLessons[0].status === 'confirmed' ? 'Potwierdzona' :
                                                        upcomingLessons[0].status === 'scheduled' ? 'Oczekuje na potwierdzenie' :
                                                            'Status nieznany'}
                                                </span>
                                            </div>
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {upcomingLessons[0].students.map(student => (
                                                            <div key={student.id} className="flex items-center bg-gray-50 rounded-full pl-1 pr-3 py-1">
                                        ...
                                        <>
                                            ...
                                            <p className="text-gray-600 mb-6">
                                                Nie masz jeszcze zaplanowanych lekcji. Ustaw swoją dostępność,
                                                aby uczniowie mogli rezerwować terminy lekcji z Tobą.
                                            </p>
                                ...
                                <div className="md:w-1/2">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            ...
                                            <div className="text-2xl font-bold text-blue-900">{upcomingLessons.length}</div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            ...
                                            <div className="text-2xl font-bold text-blue-900">
                                                {lessonsArray.reduce((total, lesson) => {
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-2 text-yellow-400 flex">
                                                    {[1, 2, 3, 4, 5].map((star) => (
                                                        <FaCheck key={star} className={`h-3 w-3 ${star <= 5 ? 'text-blue-900' : 'text-gray-300'}`} />
                                                    ))}
                                                </div>
                                            </div>
                    ...
                    <div className="border-b border-gray-200 mb-6">
                        <nav className="-mb-px flex space-x-8">
                            {[
                                ...
                                { id: 'students', name: 'Uczniowie' },
                                { id: 'courses', name: 'Kursy' },
                                { id: 'schedule', name: 'Harmonogram' },
                                { id: 'materials', name: 'Materiały' }
                            ].map((tab) => (
                                <button
                                    key={tab.id}
                                    ...
                                    {studentsLoading ? (
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                            {students.map((student) => (
                                                <StudentCard key={student.id} student={student} onInfoClick={(student) => {
                                ...
                                <div className="p-6">
                                    <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">
                                            Widok harmonogramu zajęć będzie dostępny wkrótce.
                                        </p>
                                    </div>
                                </div>
                            </motion.div>
                        ...
                        {activeTab === 'materials' && (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                                        <div className="rounded-full bg-gray-100 p-3 mb-4">
                                            <FaChalkboardTeacher className="h-6 w-6 text-gray-400" />
                                        </div>
                                        <h3 className="text-sm font-medium text-gray-900">Funkcja w przygotowaniu</h3>
                                        <p className="mt-1 text-sm text-gray-500">
